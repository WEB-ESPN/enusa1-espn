    ...
    <div class="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <div class="pr-1">
                        <select v-model="searchQueryCategory" class="form-control" placeholder="Choose by categories">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        <span v-if="statusEditing">Edit Products</span>
                ...
                <Form ref="form" @submit="handleSubmit" :validation-schema="statusEditing ? editDataSchema : createDataSchema" v-slot="{ errors }" :initial-values="formValues">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <Field name="category_id" as="select" class="form-control" :class="{ 'is-invalid': errors.category_id }" id="category_id">
...
<script setup>
    ...
    const getDatas = (page = 1) => {
        ...
        if (searchQueryCategory.value !== '') {
            queryParam = {
                ...
                category_id: searchQueryCategory.value
            };            
        } else {
            queryParam = {
                page: page,
        ...
        requestGet(`admin/products`, queryParam)
        .then((RESPONSE) => {
    ...
    const updateData = (values, { resetForm, setErrors }) => {
        ...
        requestPatch(`admin/products/update/${formValues.value.id}`, { _method: 'PATCH'}, formData)
        .then((RESPONSE) => {
    ...
    const deleteData = () => {
        requestDelete(`admin/products/destroy/${dataIdBeingDeleted.value}`)
        .then(() => {
    ...
    watch(searchQueryCategory, debounce(() => {
        getDatas();
    }, 300));
